...
const Sidebar = ({
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r flex flex-col h-full
...
transition-all duration-150 border ${
            ...
            >
              ...
              {isActive && (
                <span
                  className="ml-auto w-[5px] h-5 rounded-full
bg-red-500"
                />
              )}
            </NavLink>
...
rounded text-smtext-slate-500 hover:bg-red-50 hover: text-red-500 transition-al
duration-150"
        >
